<template>
  <aside class="w-64 bg-[#0A192F] text-white flex flex-col justify-between p-4 flex-shrink-0 h-screen">
    <div>
      <div class="text-2xl font-bold tracking-wide px-3 py-4 mb-4 flex items-center gap-2">
    ...
    <div class="flex items-center gap-3 p-2 bg-white/5 rounded-xl border border-white/10">
      ...
      <div class="flex-1 overflow-hidden">
        ...
        <p class="text-xs text-gray-400 truncate">admin@idg.com</p>
      </div>
    </div>
  </aside>
</template>